...
* [__WorldClim__](https://www.worldclim.org/data/worldclim21.html): Database of climate data for 1970-2000 available at high spatial resolution for environmental conditions and time resolutions.
* [__Twitter__](https://annahaensch.github.io/TwitterAPIWorkshop/): I put together a workshop on retrieving and analyzing Twitter Data with Python, it includes tutorials for several different tools including Tweepy, Twarc and Twurl.  You will need Twitter developer credentials to run the tutorial workbook. 
